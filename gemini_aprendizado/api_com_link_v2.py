...
GIST_URL = "https://gist.github.com/wilsonreis/4ccf4188a57fe352bab3d5cd561e6d72"
...
def analisar_codigo_com_gemini(url_codigo, api_key):
    ...
    try:
        ...
        prompt = f"""
        Por favor, analise o seguinte código Python e forneça uma análise detalhada,
        incluindo:

        - Uma descrição do que o código faz.
        - Identificação de possíveis problemas (bugs, vulnerabilidades, etc.).
        - Sugestões para melhorar o código (legibilidade, eficiência, etc.).
        - Uma explicação do porquê de cada sugestão.
        - Sugira um código refatorado e otimizado, segundo seu critério
